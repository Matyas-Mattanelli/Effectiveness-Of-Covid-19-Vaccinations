...
non_countries <- c("Africa","Asia","European Union","Europe",
                   "High income","International",
                   "Lower middle income","Low income",
                   "North America","Soouth Africa",
...
avg_temp_final$location<-gsub("Democratic Republic of the Congo",
                              "Democratic Republic of Congo",
                              avg_temp_final$location)
avg_temp_final$location<-gsub("Czech Republic","Czechia",
                              avg_temp_final$location)
avg_temp_final$location<-gsub("United States of America",
                              "United States",
                              avg_temp_final$location)
avg_temp_final$location<-gsub("Federated States of Micronesia",
                              "Micronesia (country)",
                              avg_temp_final$location)
avg_temp_final$location<-gsub("East Timor","Timor",
                              avg_temp_final$location)
avg_temp_final$location<-gsub("Faroe Islands","Faeroe Islands",
                              avg_temp_final$location)
avg_temp_final$location<-gsub("Macedonia","North Macedonia",
                              avg_temp_final$location)
avg_temp_final$location<-gsub("The Gambia","Gambia",
                              avg_temp_final$location)
avg_temp_final$location[avg_temp_final$location=="Republic of Congo"]="Congo"
avg_temp_final$location<-gsub("Pitcairn Islands","Pitcairn",
                              avg_temp_final$location)
avg_temp_final$location<-gsub("Curaçao","Curacao",
                              avg_temp_final$location)
avg_temp_final$location<-gsub("The Bahamas","Bahamas",
                              avg_temp_final$location)
avg_temp_final$location<-gsub("Sint Maarten","Sint Maarten (Dutch part)",
                              avg_temp_final$location)
